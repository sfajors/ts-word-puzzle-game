...
const boards = [
  ...
  function createWordList() {
    words.forEach((wordObj, index) => {
      ...
      wordsToFindElement.appendChild(wordDiv);
    });
  }
  ...
  function checkSelectedWord() {
    ...
    if (selectedWordStr === wordObj.word.toUpperCase()) {
      ...
      markWordAsFound(currentWordIndex);
      currentWordIndex++;
      showCurrentHint();
      drawBoard();
    } else {
  ...
  // Mark a word as found in the words list UI
  ...
  // Update the words list UI based on word statuses
  ...
  // Hide the words-to-find container
  function hideWordsList() {
    wordsToFindElement.style.display = 'none';
  }
